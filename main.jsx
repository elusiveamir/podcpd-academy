...
export default function App() {
  ...
  const SQUARE = { light:"https://square.link/u/YOUR_LIGHT", full:"https://square.link/u/YOUR_FULL", annual:"https://square.link/u/YOUR_ANNUAL" };
        ...
        <div style={{position:"fixed",inset:0,background:"rgba(11,31,53,.65)",display:"flex",alignItems:"center",justifyContent:"center",zIndex:600,padding:"1rem"}}>
          <div style={{background:surface,borderRadius:18,padding:"2rem",maxWidth:480,width:"100%",boxShadow:"0 24px 64px rgba(0,0,0,.3)",maxHeight:"85vh",overflowY:"auto"}}>
            ...
            <div style={{display:"flex",gap:9}}>
              ...
              {termsAccepted
                ? <a href={pendingBuyUrl} target="_blank" rel="noreferrer" onClick={()=>{setShowTermsGate(false);setPendingBuyUrl(null);}} style={{flex:1,display:"block",textAlign:"center",background:"#2B7FDD",color:"#fff",border:"none",padding:"11px",borderRadius:9,fontWeight:700,fontSize:".87rem",cursor:"pointer",fontFamily:"inherit",textDecoration:"none",boxSizing:"border-box"}}>Continue to Checkout →</a>
